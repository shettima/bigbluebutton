...
package org.bigbluebutton.modules.presentation.view
{
	...
	public class PresentationWindowMediator extends Mediator implements IMediator
	{
		...
		public function nextSlideE(evt:presentEvent):void {
			gotoNextSlide();
		}

		private function previousSlideE(evt:presentEvent) : void{
			gotoPreviousSlide();
		}
		...
		protected function openFileUploadWindow(e:Event) : void
		{
            ...
            //Open Phidgets InterfaceKit for sensors controls
			var phidKitEvent:InterfaceKitEvent = new InterfaceKitEvent(InterfaceKitEvent.OPEN);
			var phidKit:Dispatcher = new Dispatcher();
			phidKit.dispatchEvent(phidKitEvent);	            
        }
